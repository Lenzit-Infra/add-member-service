...
class SettingsRepository:
    ...
    def initialize_defaults(self):
        ...
        defaults = {
            ...
            "sleep_delay_min": "10",
            "sleep_delay_max": "30",
            # Conservative default — bulk-adding strangers is the single riskiest
            # action on a Telegram account; keeping per-agent daily volume low
            # and spread across many agents (see app.services.agent_selector)
            # is the main defense against flags/bans.
            "daily_limit_per_agent": "30"
        }
